...
const Inbox = ({ history, theme, setTheme, changeLanguage }) => {
  ...
  return (
    <div className="dark:text-white pb-72">
      <div
        className={`${
   ...
   `}
        ...
        >
          <div className="mb-5 font-semibold text-[22px]">
            <h1>{t("inbox")} </h1>
          </div>
          <div>
            <div>
              <div>
                {todos.length === 0 ? (
                  <div className="h-20">
                    <Link to={"/home/addTodo"}>
                      <button
                        className={` bg-oragneMain px-4 py-2 hover:px-5 hover:py-3 hover:rounded-lg  duration-200 rounded-md text-white`}
                      >
                              ...
                              <div className="flex">
                                <div className="font-semibold border-b pb-2 dark:border-[#787f98] ">
                                  <input
                                    ...
                                    className="fa bg-transparent outline-none"
                                  />
                                </div>
                              </div>
