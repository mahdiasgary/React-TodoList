...
const UnCompleted = ({ history, theme, setTheme, changeLanguage }) => {
          ...
          <div>
            <div>
              ...
              {todos.length !== 0 && (
                <div>
                  {todos.map((Todo) => (
                    <div key={Todo.id} className={`${Todo.com && "hidden"}`}>
                      {Todo.edit ? (
            ...
            <div>
              ...
              >
                <div className="px-5 border border-oragneMain rounded-md backdrop-blur-sm">
                  <div>
                    <h1 className="font-semibold text-oragneMain">
                      {t("user")}:
                    </h1>
                  </div>
